<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center gap-2">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span class="font-bold text-karama-navy-dark hidden sm:inline">لوحة التحكم</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.project-guides.index')" :active="request()->routeIs('admin.project-guides.*')">
                        أدلة المشاريع
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.project-guides.index')" :active="request()->routeIs('admin.project-guides.*')">
                أدلة المشاريع
            </x-responsive-nav-link>
